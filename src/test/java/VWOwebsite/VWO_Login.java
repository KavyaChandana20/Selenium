...
//
        ...
        //  Assert Equals generally checks for the actual result vs expected result
        ...
        /* we are using this to see the results in intellij terminal like title of the page,
         otherwise browser will quit immediately */
        try
        {
            Thread.sleep(5000);
        }
        ...
        /*Go to Terminal and enter --> allure serve allure-results
